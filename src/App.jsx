...
const officeStyles = {
  ...
  orderNotes: { marginTop: 8, marginBottom: 8, background: '#FFFFFF', border: '1px solid #E3E1D6', borderRadius: 8, padding: '10px 12px', fontSize: 12.5, color: '#14181F', lineHeight: 1.45 },
